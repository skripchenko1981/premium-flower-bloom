...
export const createOrder = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const orderId = await ctx.db.insert("orders", {
      ...
      ...(args.promocode !== undefined ? { promocode: args.promocode } : {}),
      ...
      ...(args.deliveryDate !== undefined ? { deliveryDate: args.deliveryDate } : {}),
      ...(args.deliveryTime !== undefined ? { deliveryTime: args.deliveryTime } : {}),
      ...(args.cardMessage !== undefined ? { cardMessage: args.cardMessage } : {}),
